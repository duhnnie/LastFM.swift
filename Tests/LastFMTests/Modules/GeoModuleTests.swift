...
class GeoModuleTests: XCTestCase {
    ...
    private func validateGeoTopTracks(_ topTracks: CollectionPage<GeoTopTrack>) {
    ...
    private func validateGeoTopArtists(_ topArtists: CollectionPage<GeoTopArtist>) {
    ...
    func test_getTopTracks_success() async throws {
        ...
        validateGeoTopTracks(topTracks)
    ...
    func test_getTopTracks_success() throws {
        ...
        instance.getTopTracks(params: params) { result in
            ...
            case .success(let topTracks):
                self.validateGeoTopTracks(topTracks)
    ...
    func test_getTopArtists_success() async throws {
        ...
        let topArtist = try await instance.getTopArtists(params: params)

        validateGeoTopArtists(topArtist)
    ...
    func test_getTopArtists_success() throws {
        ...
        instance.getTopArtists(params: params) { result in
            ...
            case .success(let topArtists):
                self.validateGeoTopArtists(topArtists)
            case .failure(let error):
